...
facet\_wrap(~week\_day)

ggplot(aes(x = activity, y = week\_day)) + ggridges::geom\_density\_ridges(scale = .85)
...
|:----------------|:------------|:--------------|
| Word count      | 548         | 517           |
| Character count | 3312        | 3311          |
| Sentence count  | 32          | Not available |
| Reading time    | 2.7 minutes | 2.6 minutes   |
